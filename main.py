...
def recharger(datasets):
    ...
    try:
        ...
        # On vide la liste existante puis on la remplit avec les données chargées
        # (nécessaire pour conserver la même référence de liste que dans le programme principal)
        datasets.clear()
